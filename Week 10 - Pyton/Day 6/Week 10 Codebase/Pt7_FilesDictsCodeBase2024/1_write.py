...
filePath1 = open('Day 6\Week 10 Codebase\Pt7_FilesDictsCodeBase2024/file1.txt', 'w') # folder/folder/filename
filePath1 = open('Day 6\Week 10 Codebase\Pt7_FilesDictsCodeBase2024/Melodi.txt', 'w')# write to file
filePath1.write("Melodi")
